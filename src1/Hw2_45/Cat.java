 ...
 * Mammal then Cat also implements the MakesSound interface.
 */
public class Cat extends Mammal {
     ...
     * then Cat must implement makeSound (or if it does not, then Cat also
     * becomes an abstract class). The sound Cats make is "Meow".
     *
     * Note also that Cat is implementing the abstract makeSound() method
